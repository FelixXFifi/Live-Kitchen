...
class="flex flex-col h-screen bg-[#D1DCE8] overflow-hidden selection:bg-[#D4B57F] selection:text-white">
    ...
    <div class="flex flex-none h-14 items-stretch shadow-lg border-b border-[#D4B57F]/10">
        ...
        <a href="{{ route('order.summary') }}" class="relative bg-[#345061] text-[#D4B57F] flex items-center px-8 font-serif text-[10px] tracking-[0.2em] uppercase z-20 hover:bg-[#D4B57F] hover:text-[#345061] transition-all duration-500 group">
            <div class="absolute top-0 -left-3.5 w-0 h-0 border-t-[28px] border-t-transparent border-b-[28px] border-b-transparent border-r-[14px] border-r-[#345061] group-hover:border-r-[#D4B57F] transition-all duration-500"></div>
            <i class="fas fa-receipt mr-3 opacity-70"></i>
